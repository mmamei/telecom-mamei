...
GeoXml.prototype.createMarker = function(point, name, desc, styleid, idx, instyle, visible, kml_id, markerurl,snip) {
		...
		if(instyle){
			...
			var bicon = new google.maps.MarkerImage("https://maps.google.com/mapfiles/kml/pal3/icon40.png",
	    ...
	    if (this.opts.iconFromDescription) {
	        ...
	        shadow = null;
	        if (!href) {
	            href = "https://maps.google.com/mapfiles/kml/pal3/icon40.png";
				}
	        ...
	        href = "https://maps.google.com/mapfiles/kml/pal3/icon40";
...
//	    	}
	    ...
	    if (this.opts.directions) {
	        ...
	        html2 = html + '<div ' + this.directionstyle + '>'
                     ...
                     + '<a href="#" onclick="google.maps.event.trigger(' + this.myvar + '.lastMarker,\'click3\');return false;">'+this.lang.txtfrom+'</a><br>'
                     + this.lang.txtaddrstart+'<form action="https://maps.google.com/maps" method="get" target="_blank">'
	...
	if(lnum == 0){
	 	if(this.opts.sidebarid && isnew) {
			...
			if (this.rectangleLegend){
				...
				blob = '<svg xmlns="https://www.w3.org/2000/svg" style="margin-left:0px;margin-top:0px" version="1.2" fill="#ffeecc" width="16px" height="16px">';
...
if(this.opts.polylabelclass && newgeom ) {
  ...
  if (this.basesidebar &&  newgeom) { 
    ...
    var blob;
	if (this.rectangleLegend){ 
		blob = '<svg xmlns="https://www.w3.org/2000/svg" style="margin-left:0px;margin-top:0px" version="1.2" width="16px" height="16px">';
...
GeoXml.prototype.makeIcon = function(currstyle, href, myscale, hotspot){
	...
	if (!!href) {
		...
		|| href.indexOf("-dot.png")>-1 ) {
				  tempstyle.shadow="https://maps.google.com/mapfiles/ms/icons/msmarker.shadow.png";
			  }
			  else if (href.indexOf("-pushpin.png")>-1  
		|| href.indexOf("/pause.png")>-1 
		|| href.indexOf("/go.png")>-1    
		|| href.indexOf("/stop.png")>-1     ) {
				  tempstyle.shadow="https://maps.google.com/mapfiles/ms/icons/pushpin_shadow.png";
			  }
			  else {
...
OverlayManager = function ( map , paren, opts) {
	...
	this.defaultIcon = new google.maps.MarkerImage('https://maps.google.com/mapfiles/kml/paddle/blu-circle.png',
	...
	this.ClusterIconUrl = opts.ClusterIconUrl || 'https://www.dyasdesigns.com/tntmap/images/m';

...
class svm_scale
{
	...
	{
		System.out.print(
		 "Usage: svm-scale [options] data_filename output_filename\n"
		+"options:\n"
	...
	private void output_target(PrintWriter out, double value)
	{
		if(y_scaling)
		{
			if(value == y_min)
	...
	private void output(PrintWriter out, int index, double value)
	{
	...
	private void run(String []argv) throws IOException
	{
		...
		PrintWriter out = new PrintWriter(new FileWriter(new File(argv[i+1])));
